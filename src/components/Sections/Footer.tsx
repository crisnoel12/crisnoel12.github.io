...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    borderTop: `${theme.palette.type === "light" ? "2px solid rgba(0, 0, 0, 0.12)"  : "2px solid rgba(255, 255, 255, 0.12)"}`,
    borderLeft: `${theme.palette.type === "light" ? "2px solid rgba(0, 0, 0, 0.12)"  : "2px solid rgba(255, 255, 255, 0.12)"}`,
